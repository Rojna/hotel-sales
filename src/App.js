    ...
    <div className="hTSales">
      ...
      <div className="hTSales-hotelDetails container">
        ...
        <div className="hotel-code-container row">
          ...
          {hotelSearchResults === 1 && hotelData && (
            <div className="hotel-results-container col-12 col-md-6">
              <h5>Result</h5>
              <div class="mt-3">{hotelData}ghghghghg{hotelData[0]}
                  <img src={checkbox} width="25"/> {hotelData.HotelName} - {hotelData.hotelCode}
              </div>
            </div>
          )}
        </div>
